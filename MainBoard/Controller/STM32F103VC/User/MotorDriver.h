...
*/
#define PWM_DUTY_LIMIT 8000  //PWM占空比范围0~10000，不能小于5000
...
/*编码器部分
使用了TIM3，TIM2，TIM8，TIM4
编码器A，A-PB4(TIM3-1)，B-PB5（TIM3-2）；需要remap
编码器B，A-PA15(TIM2-1)，B-PB3（TIM2-2）；需要remap
编码器C，A-PC6(TIM8-1)，B-PC7（TIM8-2）
编码器D，A-PD12(TIM4-1)，B-PD13（TIM4-2）；需要remap
*/
