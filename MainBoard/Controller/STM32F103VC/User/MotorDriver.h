...
电机A：IN1-PC9，IN2-PA11（TIM1-4），EF-PC8
电机B：IN1-PB1，IN2-PA10（TIM1-3），EF-PB0
电机C：IN1-PC5，IN2-PA9（TIM1-2），EF-PC4
电机D：IN1-PA5，IN2-PA8（TIM1-1），EF-PA4
*/
...
/*编码器部分
使用了TIM4，TIM8，TIM3，TIM5
编码器A，A-PB6(TIM4-1)，B-PB7（TIM4-2）
编码器B，A-PC6(TIM8-1)，B-PC7（TIM8-2）
编码器C，A-PA6(TIM3-1)，B-PA7（TIM3-2）
编码器D，A-PA0(TIM5-1)，B-PA1（TIM5-2）
*/
